...
(function () {
    ...
    window.sprites.breath = (function () {

        // Put your canvas drawing code (and any other code) here.

        var drawBreathBody = function (ctx) {
        ...
        var drawBreathTrail = function (ctx, trailpercent) {
        ...
        var drawBreath = function (ctx, options) {
